...
DBS=(dev-intrepiddb dev-jupiterdb dev-saturndb dev-venusdb dev-marsdb dev-mercurydb dev-lucentdb dev-neptunedb dev-earthdb dev-republicdb dev-infoprintdb)
