...
def get_bing_xml():
    ...
    market = get_market()
    return "http://www.bing.com/HPImageArchive.aspx?format=xml&idx=1&n=1&mkt=%s" % market
...
def main():
    ...
    try:
        ...
        print "Image_metadata = %s" % image_metadata
...
#mwilber            change_screensaver(image_path)
            ...
            text = str(image_name) + " -- " + str(body) + " -- " + str(imageUrl) + "\n"
